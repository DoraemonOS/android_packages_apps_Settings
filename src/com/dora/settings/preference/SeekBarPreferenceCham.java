package com.dora.settings.preference;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String DORAONS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, DORAONS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, DORAONS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(DORAONS, "interval");
            if(newInterval != null)
