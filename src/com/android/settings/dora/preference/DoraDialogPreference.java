...
public class DoraDialogPreference<T extends DialogInterface> extends DialogPreference {

    private DoraPreferenceDialogFragment mFragment;

    public DoraDialogPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    public DoraDialogPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DoraDialogPreference(Context context) {
        super(context);
    }
    ...
    private void setFragment(DoraPreferenceDialogFragment fragment) {
        mFragment = fragment;
    }
    ...
    public static class DoraPreferenceDialogFragment extends PreferenceDialogFragmentCompat {

        public static DoraPreferenceDialogFragment newInstance(String key) {
            final DoraPreferenceDialogFragment fragment = new DoraPreferenceDialogFragment();
        ...
        private DoraDialogPreference getCustomizablePreference() {
            return (DoraDialogPreference) getPreference();
        }
        ...
        private class OnDismissListener implements View.OnClickListener {
            ...
            public void onClick(View view) {
                DoraPreferenceDialogFragment.this.onClick(mDialog, mWhich);
